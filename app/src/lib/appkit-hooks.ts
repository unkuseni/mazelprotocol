...
// crashing in SSR (Cloudflare Workers). This module provides hooks that
// always return stable values: stubs during SSR / before init, real values
// after the client-side lazy provider mounts.
//
// Architecture:
