...
export function mapRawToLotteryState(raw: Record<string, any> | null): LotteryState | null {
  if (!raw) return null;
  ...
  return {
    ...
    fixedPrizeBalance: toBigInt(get("fixed_prize_balance", "fixedPrizeBalance")),
    ...
    nextDrawTimestamp: toBigInt(get("next_draw_timestamp", "nextDrawTimestamp")),
    currentDrawTickets: toNumber(get("current_draw_tickets", "currentDrawTickets")),
