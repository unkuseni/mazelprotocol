      ...
      <div className="relative z-10">
        ...
        <div className="max-w-xs mx-auto mb-6">
          ...
          <div className="h-2 bg-foreground/5 rounded-full overflow-hidden">
            <div
              className="h-full rounded-full bg-linear-to-r from-gold-dark to-gold transition-all duration-500"
          ...
          <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
            <div>
              <div className="flex items-center gap-3 mb-2">
                <div className="p-2 rounded-xl bg-linear-to-br from-emerald/20 to-gold/10 border border-emerald/20">
              ...
              <div className="lg:col-span-2 space-y-6">
                ...
                {rolldownActive && (
                  <div className="relative glass rounded-xl p-4 border border-emerald/20 overflow-hidden">
                    <div className="absolute inset-0 bg-linear-to-r from-emerald/5 to-transparent" />
