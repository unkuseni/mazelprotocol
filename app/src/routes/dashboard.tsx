    ...
    return (
      <div className="glass rounded-2xl p-5 sm:p-6">
        ...
        <div className="text-center py-8">
          ...
          <Link
            to="/play"
            className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-emerald to-emerald-dark hover:from-emerald-light hover:to-emerald text-white text-xs font-bold rounded-xl shadow-md shadow-emerald/20 transition-all hover:scale-[1.02] active:scale-[0.98]"
          >
            <Trophy size={12} />
            Buy Tickets
          </Link>
  ...
  return (
    <div className="glass rounded-2xl p-5 sm:p-6">
            ...
            >
              <div
                className={`w-full rounded-t-md transition-all duration-500 ${
                  softCapReached
                    ? "bg-gradient-to-t from-emerald-dark to-emerald"
                    : isLatest
      ...
      <div className="flex items-center gap-2 text-[10px] text-gray-500">
        ...
        <div className="flex items-center gap-1">
          <div className="w-2 h-2 rounded-sm bg-gradient-to-t from-gold-dark to-gold" />
          <span>Current</span>
        </div>
        <div className="flex items-center gap-1">
          <div className="w-2 h-2 rounded-sm bg-gradient-to-t from-white/5 to-white/10" />
          <span>Normal</span>
        </div>
      </div>
    </div>
