...
function SyndicateInfoPanel({
  ...
  return (
    <div className="glass rounded-2xl overflow-hidden">
      {/* Header gradient bar */}
      <div className="h-1.5 bg-gradient-to-r from-emerald via-emerald-light to-gold" />
        ...
        {!isMember ? (
          <div className="space-y-2">
            {isFull ? (
              ...
              <Button
                onClick={onJoin}
                className="w-full h-10 text-xs font-bold bg-gradient-to-r from-emerald to-emerald-dark hover:from-emerald-light hover:to-emerald text-white rounded-xl shadow-lg shadow-emerald/20"
              >
                <Wallet size={14} />
                Join Syndicate
              </Button>
          ...
          <Link
            to="/play"
            className="flex items-center justify-center gap-2 w-full h-10 text-xs font-bold bg-gradient-to-r from-emerald to-emerald-dark hover:from-emerald-light hover:to-emerald text-white rounded-xl shadow-lg shadow-emerald/20 transition-all"
          >
            <Target size={14} />
    ...
    <div className="min-h-screen bg-background">
      <section className="relative pt-24 pb-8 sm:pt-28 sm:pb-12 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="relative z-10 max-w-2xl mx-auto text-center mt-16 sm:mt-24">
          ...
          <Button
            onClick={() => open()}
            className="h-12 px-8 text-sm font-bold bg-gradient-to-r from-emerald to-emerald-dark hover:from-emerald-light hover:to-emerald text-white rounded-xl shadow-xl shadow-emerald/25 hover:shadow-emerald/40 transition-all duration-300 hover:scale-[1.02] active:scale-[0.98]"
          >
            <Wallet size={18} />
            Connect Wallet
          </Button>
    ...
    <div className="min-h-screen bg-background">
      <section className="relative pt-24 pb-8 sm:pt-28 sm:pb-12 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="relative z-10 max-w-2xl mx-auto text-center mt-16 sm:mt-24">
          ...
          <Link
            to="/syndicates"
            className="inline-flex items-center gap-2 h-11 px-6 text-sm font-bold bg-gradient-to-r from-emerald to-emerald-dark hover:from-emerald-light hover:to-emerald text-white rounded-xl shadow-lg shadow-emerald/20 transition-all"
          >
            <ChevronLeft size={16} />
            Browse Syndicates
          </Link>
      ...
      <section className="relative pt-20 sm:pt-24 px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          ...
          <nav className="flex items-center gap-2 text-xs text-gray-500 mb-4">
            ...
            <ChevronRight size={12} />
            <span className="text-emerald-light font-medium truncate max-w-[200px]">
              {syndicate.name}
            </span>
          </nav>
        </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          <div className="flex flex-col lg:flex-row gap-4">
            ...
            <div className="flex-1 min-w-0">
              <div className="glass rounded-2xl overflow-hidden h-[calc(100vh-10rem)] min-h-[500px]">
                {isMember ? (
                  <SyndicateChat
                  ...
                  <div className="flex flex-col items-center justify-center h-full px-6 text-center">
                    ...
                    {syndicate.isPublic &&
                      ...
                      syndicate.members < syndicate.maxMembers && (
                        <Button
                          onClick={handleJoin}
                          className="h-10 px-6 text-xs font-bold bg-gradient-to-r from-emerald to-emerald-dark hover:from-emerald-light hover:to-emerald text-white rounded-xl shadow-lg shadow-emerald/20"
                        >
                          <Users size={14} />
                          Join to Chat
                        </Button>
