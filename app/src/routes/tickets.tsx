          ...
          <div className="flex items-center justify-between">
            ...
            {ticket.status === "won" && !ticket.isClaimed && (
              <Button
                ...
                size="sm"
                className="h-8 px-4 text-xs font-bold bg-gradient-to-r from-gold-dark to-gold hover:from-gold to-gold-light text-navy rounded-lg shadow-md shadow-gold/20 hover:shadow-gold/30 transition-all hover:scale-[1.02] active:scale-[0.98]"
              >
                <Gift size={12} />
                Claim Prize
              </Button>
...
function UnclaimedBanner({
  ...
  return (
    <div className="relative glass-strong rounded-2xl p-5 sm:p-6 overflow-hidden border border-gold/20">
      <div className="absolute inset-0 bg-gradient-to-br from-gold/[0.04] via-transparent to-emerald/[0.02]" />
      ...
      <div className="relative z-10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        ...
        <Button
          onClick={onClaimAll}
          className="h-11 px-6 bg-gradient-to-r from-gold-dark to-gold hover:from-gold to-gold-light text-navy font-bold rounded-xl shadow-lg shadow-gold/25 hover:shadow-gold/40 transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] shrink-0"
        >
          <Gift size={16} />
  ...
  return (
    <div className="glass rounded-2xl p-12 text-center">
      ...
      {filter === "all" && (
        <Link
          to="/play"
          className="inline-flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-emerald to-emerald-dark hover:from-emerald-light hover:to-emerald text-white text-sm font-bold rounded-xl shadow-lg shadow-emerald/25 hover:shadow-emerald/40 transition-all duration-300 hover:scale-[1.02] active:scale-[0.98]"
        >
          <Trophy size={14} />
          Buy Tickets
        </Link>
    ...
    if (searchQuery.trim()) {
      ...
      result = result.filter(
        (t) =>
          ...
          (t.syndicateName && t.syndicateName.toLowerCase().includes(q)) ||
