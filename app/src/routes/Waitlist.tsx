  ...
  return (
    <div className="flex items-center justify-center gap-3 sm:gap-4">
      {units.map((u) => (
        <div
          key={u.label}
          className="w-16 sm:w-20 rounded-xl glass px-2 py-3 text-center"
        >
          <div className="text-2xl sm:text-3xl font-black text-foreground tabular-nums">
            {String(u.value).padStart(2, "0")}
          </div>
          <div className="text-[9px] sm:text-[10px] uppercase tracking-[0.18em] text-muted-foreground mt-1">
            {u.label}
          </div>
        </div>
      ))}
    ...
    >
      ...
      <div className="mt-2.5 relative">
        ...
        <input
          ...
          spellCheck={false}
          maxLength={44}
          className="w-full h-11 pl-10 pr-4 rounded-xl bg-surface-1/50 border border-border text-sm text-foreground placeholder:text-muted-foreground/45 focus:outline-none focus:border-emerald/30 focus:ring-2 focus:ring-emerald/10 transition-colors"
        />
      </div>
...
function FaqItem({ q, a }: { q: string; a: string }) {
  return (
    <details className="group rounded-2xl border border-border bg-surface-1/40 open:bg-surface-1/70 transition-colors">
    ...
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
      ...
      <header className="relative z-20">
        <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
          <Link to="/" className="flex items-center gap-2">
            <div className="w-9 h-9 rounded-xl bg-linear-to-br from-gold-400/20 to-emerald/10 border border-gold-500/25 flex items-center justify-center">
      ...
      <section className="relative flex items-center justify-center overflow-hidden pt-10 pb-20 sm:pb-28">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black tracking-tight leading-[1.05] mb-6 font-display">
            The First{" "}
          ...
          {/* Countdown */}
          <div className="mb-10">
            <p className="text-[10px] uppercase tracking-[0.22em] text-muted-foreground/70 mb-3">
              Public launch in
            </p>
            <LaunchCountdown />
          </div>
          ...
          {joined ? (
            <div className="relative glass-gold rounded-2xl border border-gold-500/25 p-8 sm:p-10 max-w-xl mx-auto glow-gold overflow-hidden">
              ...
              <div className="relative z-10">
                <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-emerald/15 border border-emerald/30 mb-5">
                  <PartyPopper size={24} className="text-emerald-light" />
                </div>
              ...
              <div className="flex flex-wrap items-center justify-center gap-x-5 gap-y-2 mt-8 text-[11px] text-muted-foreground">
                {socialProof.map((item, i) => (
                  <span key={item} className="inline-flex items-center gap-2">
                    ...
                    {i === 0 && (
                      <Users size={12} className="text-emerald-light" />
                    )}
                    {i === 1 && <Shield size={12} className="text-gold-400" />}
                    {i === 2 && <Lock size={12} className="text-emerald-light" />}
                    {item}
                  </span>
                ))}
              </div>
      ...
      <section id="how" className="py-16 sm:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-gold-500/8 border border-gold-500/15 mb-3">
              <div className="w-1.5 h-1.5 rounded-full bg-gold-400" />
              <span className="text-[10px] font-bold text-gold-400 uppercase tracking-[0.18em]">
                The Mechanism
              </span>
            </div>
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-black font-display tracking-tight mb-3">
      ...
      {/*  FEATURES                                                        */}
      {/* ================================================================ */}
      <section id="features" className="py-16 sm:py-24 bg-surface-1/30 border-y border-border/60">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-gold-500/8 border border-gold-500/15 mb-3">
              <div className="w-1.5 h-1.5 rounded-full bg-gold-400" />
            ...
            <p className="text-sm sm:text-base text-muted-foreground max-w-2xl mx-auto">
              Every mechanic is on-chain, auditable, and engineered so the
      ...
      <section className="py-16 sm:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 max-w-5xl mx-auto">
            {[
              { match: "Match 5", prize: "$28,000", rolldown: "~$46,000*", balls: [1, 2, 3, 4, 5] },
              { match: "Match 4", prize: "$800", rolldown: "~$1,330*", balls: [1, 2, 3, 4] },
              { match: "Match 3", prize: "$18", rolldown: "~$90*", balls: [1, 2, 3] },
              { match: "Match 2", prize: "Free Ticket", rolldown: "Free Ticket", balls: [1, 2] },
            ].map((tier) => (
              <div
                key={tier.match}
              ...
              >
                ...
                <div className="text-[11px] text-gold-400/80 mt-1">
                  {tier.rolldown}
                </div>
              </div>
            ))}
      ...
      {/*  ROADMAP                                                         */}
      {/* ================================================================ */}
      <section id="roadmap" className="py-16 sm:py-24 bg-surface-1/30 border-y border-border/60">
              ...
              >
                ...
                <div
                  className={cn(
                    ...
                    phase.active ? "text-emerald-light" : "text-muted-foreground",
                  )}
                >
                  {phase.active && (
                    <CheckCircle2 size={11} className="text-emerald-light" />
                  )}
                  {phase.status}
                </div>
                <p className="text-xs text-muted-foreground leading-relaxed">
      ...
      <section className="relative py-20 sm:py-28 overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black font-display tracking-tight mb-4">
          ...
          {!joined ? (
            ...
            <div className="inline-flex items-center gap-2 px-5 py-3 rounded-xl bg-emerald/10 border border-emerald/25 text-emerald-light font-semibold">
          ...
          <footer className="mt-16 pt-8 border-t border-border/60">
            <div className="flex flex-col items-center gap-4">
              <div className="flex items-center gap-2">
                <div className="w-7 h-7 rounded-lg bg-linear-to-br from-gold-400/20 to-emerald/10 border border-gold-500/25 flex items-center justify-center">
              ...
              <div className="flex items-center gap-3">
                {[
                  ...
                  { href: SOCIALS.discord, label: "Discord", icon: MessageCircle },
