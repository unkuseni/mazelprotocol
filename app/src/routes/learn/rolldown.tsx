...
function MathCallout({
  ...
  return (
    <div className="glass rounded-xl p-4 border border-foreground/6">
      ...
      <div className="p-3 rounded-lg bg-card/50 dark:bg-navy-deep/50 border border-foreground/4 mb-2">
