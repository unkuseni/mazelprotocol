      ...
      className={`
        ...
        ${
          highlight
            ...
            : "bg-foreground/[0.02] border border-foreground/[0.06] hover:border-foreground/[0.12] hover:bg-foreground/[0.04]"
        }
      `}
    >
      ...
      <div
        className={`absolute top-0 left-6 right-6 h-px ${
          highlight
            ...
            : "bg-gradient-to-r from-transparent via-foreground/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity"
        }`}
      />
