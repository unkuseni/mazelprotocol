...
const trustBadges = [
	{
		...
		description:
			"Every ticket, draw, and prize distribution is recorded on Solana and publicly auditable.",
	},
	{
		icon: Shield,
		title: "Switchboard VRF",
		description:
			"Trusted Execution Environment randomness — even oracle operators cannot manipulate results.",
	},
	{
		icon: CheckCircle,
		title: "Solvency Checks",
		description:
			"Permissionless solvency verification — anyone can confirm the protocol has funds to pay all prizes.",
	},
	{
		icon: Lock,
		title: "Timelock Security",
		description:
			"24-hour timelock on all configuration changes. Two-step authority transfer prevents accidental control loss.",
	},
];
...
const rolldownSteps = [
	{
		...
		description:
			"Every $2.50 ticket grows the jackpot. 55.6% goes to prizes, 39.4% to fixed payouts, 5% to safety reserves.",
	},
	{
		step: "02",
		title: "Soft Cap Reached ($1.75M)",
		description:
			"Probabilistic rolldown becomes possible. Each draw has a chance to trigger full jackpot distribution.",
	},
	{
		step: "03",
		title: "Probability Rises",
		description:
			"The chance increases linearly as the jackpot grows. At $2M, there's a ~50% chance of rolldown each draw.",
	},
	{
		step: "04",
		title: "Hard Cap ($2.25M) — Forced Rolldown",
		description:
			"100% guaranteed. The entire jackpot distributes via pari-mutuel. Player edge reaches +104% under optimal conditions.",
	},
];
...
function HeroSection({
	...
	loading: boolean;
	/** On-chain next draw time (ms) or null when unknown (review L3) */
	nextDrawTimeMs: number | null;
	/** Current on-chain draw id, or null when unknown */
	drawId: number | null;
	/** Tickets sold in the current draw, or null when unknown */
	ticketsSold: number | null;
	/** Whether ticket sales are currently open (from on-chain state) */
	isSaleOpen: boolean;
}) {
	...
	return (
		<section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden scanlines">
			...
			<div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
				...
				{/* Countdown — uses the on-chain next-draw schedule when available */}
				{nextDrawTimeMs ? (
			...
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				<div className="max-w-4xl mx-auto">
					<SectionHeading
						...
						title="How Rolldown Works"
						description="A four-phase cycle that turns the lottery math in your favor."
						icon={TrendingUp}
					/>
		...
		<section className="py-16 sm:py-20 bg-muted/20">
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				<div className="max-w-3xl mx-auto">
					<SectionHeading
						eyebrow="Your Edge"
						title="Calculate Your Edge"
						description="Use the interactive calculator to see your expected value based on current jackpot and estimated ticket volume."
						icon={BarChart3}
					/>
		...
		<section className="py-16 sm:py-20">
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				<SectionHeading
					...
					title="Why MazelProtocol?"
					description="A fundamentally different approach to lottery economics."
					icon={Sparkles}
				/>
		...
		<section className="py-16 sm:py-20 bg-muted/20">
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				<SectionHeading
					...
					description="Every aspect of the protocol is verifiable on-chain. No trust required."
					icon={Shield}
				/>
			...
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				<div className="max-w-2xl mx-auto text-center">
					<div className="rounded-3xl p-6 sm:p-10 lg:p-14 bg-linear-to-br from-gold-500/8 via-surface-1/50 to-emerald-500/5 border border-gold-500/15 glow-gold">
						<Trophy
							size={32}
							className="mx-auto mb-4 text-gold-400 sm:size-10 lg:size-12"
						/>
						<h2 className="text-2xl sm:text-3xl lg:text-4xl font-black text-foreground mb-4 font-display">
							{rolldownActive ? "The +EV Window Is Open" : "Ready to Play?"}
						</h2>
...
export default function LandingPage() {
	...
	const jackpotUnknown = state === null;

	return (
		<div className="min-h-screen">
			<HeroSection
				jackpotDollars={jackpotDollars}
				jackpotUnknown={jackpotUnknown}
				rolldownActive={rolldownActive}
				loading={loading}
				nextDrawTimeMs={nextDrawTimeMs}
				drawId={drawId}
