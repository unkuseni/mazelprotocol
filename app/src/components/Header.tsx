...
function MobileWalletButton() {
	...
	return (
		<button
			type="button"
			onClick={() => open({ view: "Connect", namespace: "solana" })}
			className="w-full flex items-center justify-center gap-2 px-4 py-2.5 text-sm font-bold tracking-wide text-primary-foreground bg-linear-to-b from-cyan-300 to-cyan-600 rounded-lg shadow-lg shadow-cyan-500/30"
		>
			<Wallet size={16} />
			<span>Connect Wallet</span>
		</button>
