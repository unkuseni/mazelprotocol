  ...
  return (
    <div ref={containerRef} className={`relative ${className}`}>
      ...
      >
        ...
        <div className="absolute inset-0 bg-linear-to-br from-card/80 via-muted/60 to-card/80 dark:from-navy-light/80 dark:via-navy/60 dark:to-navy-deep/80 backdrop-blur-sm border border-gold/10 rounded-2xl" />
