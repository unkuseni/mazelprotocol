				...
				>
					<div
						className={`w-full h-full rounded-full flex items-center justify-center text-[10px] font-bold ${
							ball.isGold
								? "bg-linear-to-br from-gold-200 to-gold-500 text-white/70"
								: "bg-linear-to-br from-emerald-300 to-emerald-600 text-white/70"
						}`}
						style={{
	...
	return (
		<div className="flex items-center gap-1.5">
			{numbers.map((num, i) => {
              ...
              ${
								isMatched
									? "bg-linear-to-br from-gold-200 to-gold-400 text-primary-foreground shadow-sm shadow-gold-500/20"
