...
function MessageAvatar({
  ...
  return (
    <div className="relative shrink-0">
      <div
        className={`w-8 h-8 rounded-lg bg-gradient-to-br ${gradient} flex items-center justify-center text-white text-xs font-bold shadow-md`}
      >
...
function ConnectWalletPrompt() {
  ...
  return (
    <div className="flex flex-col items-center justify-center py-8 px-4">
      ...
      <Button
        onClick={() => open()}
        className="h-9 px-5 text-xs font-bold bg-gradient-to-r from-emerald to-emerald-dark hover:from-emerald-light hover:to-emerald text-white rounded-xl shadow-lg shadow-emerald/20"
      >
        <Wallet size={14} />
        Connect Wallet
      </Button>
            ...
            <div className="shrink-0 border-t border-foreground/[0.06] p-3 space-y-2">
              ...
              <div className="flex items-center gap-2">
                ...
                <Button
                  ...
                  className="h-9 w-9 p-0 rounded-xl bg-gradient-to-r from-emerald to-emerald-dark hover:from-emerald-light hover:to-emerald text-white shadow-md shadow-emerald/20 disabled:opacity-30 disabled:shadow-none transition-all"
                >
                  <Send size={14} />
                </Button>
              </div>
