...
const MILESTONES = [
	{
		amount: SEED_AMOUNT,
		label: "Seed",
		description: "Initial jackpot funding",
	},
	...
	{ amount: 1_500_000, label: "$1.5M", description: "Fee hits 40%" },
	{
		amount: SOFT_CAP,
		label: "Soft Cap",
		description: "Probabilistic rolldown begins",
	},
	...
	return (
		...
		>
			...
			<p className="text-xs text-muted-foreground mb-6">
				As the jackpot grows from {formatCurrency(SOFT_CAP)} to{" "}
				{formatCurrency(HARD_CAP)}, the probability of rolldown increases
				linearly from 0% to 100%.
			</p>

			{/* SVG Chart */}
			<div
				className="relative w-full max-h-64 mb-6"
