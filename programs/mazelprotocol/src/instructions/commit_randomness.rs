...
//! 2. Stores the commit slot for later verification
...
/// 4. Stores the commit slot and randomness account reference
...
pub fn handler(ctx: Context<CommitRandomness>) -> Result<()> {
    ...
    // This is determined by jackpot level and probabilistic check
    if jackpot_balance >= hard_cap {
        // Hard cap reached - force rolldown
        ...
        // The actual rolldown decision will be made during execute_draw
